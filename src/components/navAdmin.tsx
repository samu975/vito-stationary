...
export const NavAdmin = () => {
  const inactiveLink = "flex gap-1 p-1 my-4";
  const activeLink =
    inactiveLink + " bg-white text-black-900 rounded-l-lg shadow";
  const pathname = usePathname();

  return (
    <>
      <aside className="text-black p-4 pr-0">
        <Link href={"/"} className="flex gap-1 mb-6 pr-2">
          <svg
        ...
        <nav className="flex flex-col gap-1">
          ...
          <Link
            href={"/admin/users"}
            className={
              pathname.includes("/admin/users") ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
